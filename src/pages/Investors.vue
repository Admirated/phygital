        ...
        <div class="col-12 col-lg-11 p-0" v-for="investor in investors">
            <div class="card border-0 mb-5 pb-3 mb-lg-4 pb-lg-0">
                <div class="card-body p-0 px-4 px-lg-0">
                    ...
                    <div class="row m-0 d-inline-block p-0 pt-2 pe-lg-5 ps-lg-4 pt-lg-4 investor-row">
                        <div class="col-12 p-0 ps-1 pb-4 d-flex align-items-center flex-flow-wrap">
                            <div class="icon-box d-flex align-items-center justify-content-center mt-3">
                                <UIIcon path="Build" />
                            </div>
                            <div class="ps-2 mt-2 mt-lg-3 investor-title">
                                <h5 class="mb-1 d-inline-block d-lg-block" v-text="investor.title"></h5>
                                <UIIcon class="flag-icon ps-3 d-inline-block d-lg-none" :path="'Flag_' + investor.country_code"/>
                                <p class="description mb-0 pt-0 pt-lg-1" v-text="investor.description"></p>
                            </div>
                            <UIIcon class="flag-icon ps-3 mt-3 d-none d-lg-flex" :path="'Flag_' + investor.country_code"/>
                            <div class="feature mt-4 mt-lg-0">
                                <span>Funding target</span>
                                <p class="mb-0 mt-2" v-text="numberFormat(investor.price) + ' ' + investor.currency"></p>
                            </div>
                            <div class="feature mt-4 mt-lg-0">
                            ...
                            <div class="feature mt-4 mt-lg-0">
                                ...
                                <p class="mb-0 mt-2" v-text="investor.percent + '%'"></p>
                            </div>
                        </div>
                        <hr>
                        <InvestorCalendar month="3"/>
                        <div class="col-12 p-0 mt-4 pt-1">
                            <button class="ui-btn btn-outline color-black">View</button>
                            <button class="ui-btn btn-outline color-black ms-0 ms-lg-3" disabled>Withdraw profit</button>
                        </div>
                    </div>
                </div>
            </div>
