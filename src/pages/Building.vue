            ...
            <div class="card border-0">
                <div class="card-body">
                    <div class="row m-0">
                        <div class="col-12 col-lg-6 p-0 px-2 px-lg-0">
                            <div class="d-flex align-items-center">
                                ...
                                <UIIcon class="flag-icon ps-2" :path="'Flag_' + country_code"/>
                            </div>
                            <p class="description pe-0 pe-lg-5" v-text="description"></p>
                            <p class="status">
                                <span v-text="status"></span> | Published on <span v-text="published_at"></span> <span v-text="published_ago" class="d-inline-block"></span></p>
                        </div>
                        <div class="col-12 col-lg-6 p-0 ps-0 ps-lg-3 mt-3 mt-lg-0">
                            <div class="card border-0 info-card">
                                <div class="card-body">
                                    <div class="price mb-2 pb-1" v-html="priceText"></div>
                                    <ProgressBar :percent="this.price.percent"/>
                                    <div class="investor-counter mt-2 pt-1" v-text="investorCounter"></div>
                                    <div class="currency-list mt-4">
                                        <span>Accepted currencies:</span>
                                        <div class="d-flex mt-1">
                                            <div class="currency p-2"
                    ...
                    <div class="row m-0 mt-4 mt-lg-5 p-0">
                        <div class="col-6 col-lg-3 feature p-0" v-for="feature in features">
                            <div class="row m-0 mb-4 mb-lg-0">
                                <div class="col-3 p-0 pb-2 pb-lg-0">
                                    <span class="icon" :style="'background-image: url(\'/src/assets/images/icons/' + feature.icon + '.svg\')'"></span>
                                </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                country_code: 'es',
                description: 'Build your Real Estate Portfolio. Meet phygital real estate, a simple, secure real estate investment platform who joins developers, whales and crypto investors.',
                status: 'Active',
